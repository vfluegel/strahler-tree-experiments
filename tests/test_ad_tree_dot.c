...
int main(void) {
  ...
  char *first = render(&game, &result, AD_DOT_PLAYER_BOTH, AD_DOT_LABEL_SETS,
                       32, &priority_map);
  char *second = render(&game, &result, AD_DOT_PLAYER_BOTH, AD_DOT_LABEL_SETS,
                        32, &priority_map);
  ...
  char *none =
      render(&game, &result, AD_DOT_PLAYER_EVEN, AD_DOT_LABEL_NONE, 0, nullptr);
